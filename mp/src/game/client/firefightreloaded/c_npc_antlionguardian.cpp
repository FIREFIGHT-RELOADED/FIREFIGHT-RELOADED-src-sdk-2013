...
class C_NPC_AntlionGuardian : public C_AI_BaseNPC
{
public:
	C_NPC_AntlionGuardian() {}

	DECLARE_CLASS( C_NPC_AntlionGuardian, C_AI_BaseNPC );
	DECLARE_CLIENTCLASS();
 	DECLARE_DATADESC();
...
private:
	...
	C_NPC_AntlionGuardian( const C_NPC_AntlionGuardian & );
};
...
// Save/restore
//-----------------------------------------------------------------------------
BEGIN_DATADESC( C_NPC_AntlionGuardian )
END_DATADESC()
...
// Networking
//-----------------------------------------------------------------------------
IMPLEMENT_CLIENTCLASS_DT(C_NPC_AntlionGuardian, DT_NPC_AntlionGuardian, CNPC_AntlionGuardian)
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_NPC_AntlionGuardian::OnDataChanged( DataUpdateType_t type )
{
	BaseClass::OnDataChanged( type );

	if ( (type == DATA_UPDATE_CREATED) && m_bInCavern )
	{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_NPC_AntlionGuardian::UpdateBleedingPerformance()
{
	// get my particles
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_NPC_AntlionGuardian::ClientThink()
{
