...
private:
	...
	CFRImagePanel		*m_pUpArrow;
	vgui::ImagePanel	*m_pLine;
	CFRImagePanel		*m_pDownArrow;
...
//-----------------------------------------------------------------------------
class CFRFooter : public vgui::EditablePanel
{
	DECLARE_CLASS_SIMPLE( CFRFooter, vgui::EditablePanel );

public:
	CFRFooter( Panel *parent, const char *panelName );
	virtual ~CFRFooter();
