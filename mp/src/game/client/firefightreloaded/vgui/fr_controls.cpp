...
DECLARE_BUILD_FACTORY( CFRFooter );
...
CExRichText::CExRichText(Panel *parent, const char *name) : RichText(parent, name)
{
	...
	m_pUpArrow = new CFRImagePanel( this, "UpArrow" );
	if ( m_pUpArrow )
	{
	...
	m_pDownArrow = new CFRImagePanel( this, "DownArrow" );
	if ( m_pDownArrow )
	{
...
//-----------------------------------------------------------------------------
CFRFooter::CFRFooter( Panel *parent, const char *panelName ) : BaseClass( parent, panelName ) 
{
	SetVisible( true );
	SetAlpha( 0 );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRFooter::ApplySchemeSettings( vgui::IScheme *pScheme )
{
	BaseClass::ApplySchemeSettings( pScheme );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRFooter::ApplySettings( KeyValues *inResourceData )
{
	BaseClass::ApplySettings( inResourceData );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRFooter::AddNewButtonLabel( const char *name, const char *text, const char *icon )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRFooter::ShowButtonLabel( const char *name, bool show )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRFooter::PaintBackground( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRFooter::ClearButtons( void )
{
