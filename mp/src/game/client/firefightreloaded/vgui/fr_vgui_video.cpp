...
DECLARE_BUILD_FACTORY( CFRVideoPanel );

//-----------------------------------------------------------------------------
// 
//-----------------------------------------------------------------------------
CFRVideoPanel::CFRVideoPanel( vgui::Panel *parent, const char *panelName ) : VideoPanel( 0, 0, 50, 50 )
{
	SetParent( parent );
...
// 
//-----------------------------------------------------------------------------
void CFRVideoPanel::ReleaseVideo()
{
...
// 
//-----------------------------------------------------------------------------
void CFRVideoPanel::ApplySettings( KeyValues *inResourceData )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRVideoPanel::GetPanelPos( int &xpos, int &ypos )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRVideoPanel::OnVideoOver()
{
