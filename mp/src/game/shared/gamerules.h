...
enum FirefightSecondaryGamemodes
{
	FIREFIGHT_SECONDARY_DEFAULT,
	FIREFIGHT_SECONDARY_HEALTHCRISIS,
	FIREFIGHT_SECONDARY_DOUBLETROUBLE,
	FIREFIGHT_SECONDARY_HARDCORE,
	FIREFIGHT_SECONDARY_REALISM,
	FIREFIGHT_SECONDARY_HARDCOREREALISM,
	FIREFIGHT_SECONDARY_WAVESURVIVAL
};
...
enum FirefightPerks
{
	...
	FIREFIGHT_PERK_MOREHEALTH,
	FIREFIGHT_PERK_MOREARMOR,
...
// Setup
	...
	virtual const char *GetGamemodeServerName(bool localServer = false);
	bool bHasRandomized;
	int iRandomGamemode;
