...
//=============================================================================
	...
	const char *CMultiplayRules::GetNPCName(CBaseEntity *pVictim)
	{
		...
		if (Q_stristr(entityClassname, "npc_metropolice"))
		{
			name = "Civil Protection Officer";
		}
		else if (Q_stristr(entityClassname, "npc_combine_s"))
		{
			name = "Combine Soldier";
		}
		else if (Q_stristr(entityClassname, "npc_combine_e"))
		{
			name = "Combine Elite Soldier";
		}
		else if (Q_stristr(entityClassname, "npc_combine_p"))
		{
			name = "Combine Prison Guard";
		}
		else if (Q_stristr(entityClassname, "npc_combine_shot"))
		{
			name = "Combine Shotgunner";
		}
		else if (Q_stristr(entityClassname, "npc_combine_ace"))
		{
			name = "Combine Ace";
		}
		else if (Q_stristr(entityClassname, "npc_hunter"))
		{
			name = "Combine Hunter";
		}
		else if (Q_stristr(entityClassname, "npc_antlion"))
		{
			name = "Antlion";
		}
		else if (Q_stristr(entityClassname, "npc_antlionworker"))
		{
			name = "Antlion Worker";
		}
		else if (Q_stristr(entityClassname, "npc_antlionguard"))
		{
			name = "Antlion Guard";
		}
		else if (Q_stristr(entityClassname, "npc_antlionguardian"))
		{
			name = "Antlion Guardian";
		}
		else if (Q_stristr(entityClassname, "npc_zombie"))
		{
			name = "Zombie";
		}
		else if (Q_stristr(entityClassname, "npc_zombie_torso"))
		{
			name = "Zombie Torso";
		}
		else if (Q_stristr(entityClassname, "npc_fastzombie"))
		{
			name = "Fast Zombie";
		}
		else if (Q_stristr(entityClassname, "npc_fastzombie_torso"))
		{
			name = "Fast Zombie Torso";
		}
		else if (Q_stristr(entityClassname, "npc_poisonzombie"))
		{
			name = "Poison Zombie";
		}
		else if (Q_stristr(entityClassname, "npc_zombine"))
		{
			name = "Zombine";
		}
		else if (Q_stristr(entityClassname, "npc_headcrab"))
		{
			name = "Headcrab";
		}
		else if (Q_stristr(entityClassname, "npc_headcrab_fast"))
		{
			name = "Fast Headcrab";
		}
		else if (Q_stristr(entityClassname, "npc_headcrab_poison"))
		{
			name = "Poison Headcrab";
		}
		else if (Q_stristr(entityClassname, "npc_houndeye"))
		{
			name = "Houndeye";
		}
		else if (Q_stristr(entityClassname, "npc_bullsquid"))
		{
			name = "Bullsquid";
		}
		else if (Q_stristr(entityClassname, "npc_vortigaunt"))
		{
			name = "Vortigaunt";
		}
		else if (Q_stristr(entityClassname, "npc_assassin"))
		{
			name = "Combine Female Assassin";
		}
		else if (Q_stristr(entityClassname, "npc_manhack"))
		{
	...
	void CMultiplayRules::NPCKilled(CBaseEntity *pVictim, const CTakeDamageInfo &info)
	{
		...
		// variant_t value;
		// g_EventQueue.AddEvent( "game_playerdie", "Use", value, 0, pVictim, pVictim );
		FireTargets("game_npcdie", pVictim, pVictim, USE_TOGGLE, 0);
		...
		if (pKiller->IsPlayer())
		{
			...
			{
				// if a player dies in a deathmatch game and the killer is a client, award the killer some points
				pScorer->IncrementFragCount(IPointsForKillNPC(pScorer, pVictim));
				...
				//variant_t value;
				//g_EventQueue.AddEvent( "game_playerkill", "Use", value, 0, pScorer, pScorer );
				FireTargets("game_npckill", pScorer, pScorer, USE_TOGGLE, 0);
			}
		}
		else if (pKiller->IsNPC())
		{
	...
	void CMultiplayRules::DeathNoticeNPC(CBaseEntity *pVictim, const CTakeDamageInfo &info)
	{
		// Work out what killed the player, and send a message to all clients about it
		const char *killer_weapon_name = "world";		// by default, the player is killed by the world
		int killer_ID = 0;
