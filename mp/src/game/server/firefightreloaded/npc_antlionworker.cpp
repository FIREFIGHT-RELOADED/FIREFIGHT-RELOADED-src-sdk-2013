...
// base antlion stuff
ConVar	sk_antlion_worker_swipe_damage("sk_antlion_worker_swipe_damage", "5");
ConVar	sk_antlion_worker_jump_damage("sk_antlion_worker_jump_damage", "5");
ConVar  sk_antlion_worker_air_attack_dmg("sk_antlion_worker_air_attack_dmg", "10");
