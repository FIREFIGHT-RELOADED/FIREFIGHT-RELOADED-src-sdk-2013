...
ConVar sk_agrunt_health( "sk_agrunt_health", "60" );
ConVar sk_agrunt_dmg_punch( "sk_agrunt_dmg_punch", "10" );
...
class CNPC_AlienGrunt : public CAI_BaseNPC
{
	DECLARE_CLASS(CNPC_AlienGrunt, CAI_BaseNPC);
public:
...
LINK_ENTITY_TO_CLASS( npc_agrunt, CNPC_AlienGrunt );
...
//=========================================================
AI_BEGIN_CUSTOM_NPC(npc_agrunt, CNPC_AlienGrunt)
