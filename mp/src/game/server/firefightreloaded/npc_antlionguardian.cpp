...
ConVar	sk_antlionguardian_dmg_charge( "sk_antlionguardian_dmg_charge", "20" );
ConVar	sk_antlionguardian_dmg_shove( "sk_antlionguardian_dmg_shove", "10" );
...
ConVar	sk_antlionguardian_health( "sk_antlionguardian_health", "450" );
