...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
ConVar	sk_battery( "sk_battery","30" );			
...
ConVar	sk_lightarmor("sk_lightarmor", "100");
...
ConVar	sk_heavyarmor("sk_heavyarmor", "200");
...
bool CHL2_Player::ApplyHealth(float health)
{
