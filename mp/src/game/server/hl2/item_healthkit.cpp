...
ConVar	sk_healthcharger( "sk_healthcharger","150" );		
...
bool CHealthKit::MyTouch( CBasePlayer *pPlayer )
{
	...
	return (pHL2Player && pHL2Player->ApplyHealth(sk_healthkit.GetFloat()));
}
...
public:
	...
	{
		CHL2_Player *pHL2Player = dynamic_cast<CHL2_Player *>(pPlayer);
		return (pHL2Player && pHL2Player->ApplyHealth(sk_healthvial.GetFloat()));
	}
};
