...
#include "fr_moddingmenu_weapons.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRModdingMenu_Weapons::CFRModdingMenu_Weapons(IViewPort *pViewPort) : Frame(NULL, PANEL_MODDING_WEAPONS)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/ModdingMenu_Weapons.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CFRModdingMenu_Weapons::~CFRModdingMenu_Weapons()
{
}
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Weapons::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Weapons::ShowPanel(bool bShow)
{
...
void CFRModdingMenu_Weapons::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Weapons::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CFRModdingMenu_Weapons::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Weapons::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Weapons::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Weapons::SetLabelText(const char *textEntryName, const char *text)
{
...
void CFRModdingMenu_Weapons::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRModdingMenu_Weapons::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
