...
#ifndef FR_STOREMENU_AMMO_H
#define FR_STOREMENU_AMMO_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CFRStoreMenuAmmo : public vgui::Frame, public IViewPortPanel
{
private:
	DECLARE_CLASS_SIMPLE( CFRStoreMenuAmmo, vgui::Frame );

public:
	CFRStoreMenuAmmo(IViewPort *pViewPort);
	virtual ~CFRStoreMenuAmmo();

	virtual const char *GetName( void ) { return PANEL_BUY_AMMO; }
