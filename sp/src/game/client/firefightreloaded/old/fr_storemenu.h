...
//-----------------------------------------------------------------------------
class CFRStoreMenu : public vgui::Frame, public IViewPortPanel
{
private:
	DECLARE_CLASS_SIMPLE( CFRStoreMenu, vgui::Frame );

public:
	CFRStoreMenu(IViewPort *pViewPort);
	virtual ~CFRStoreMenu();
