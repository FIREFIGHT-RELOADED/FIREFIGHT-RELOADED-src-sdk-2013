...
DECLARE_BUILD_FACTORY_DEFAULT_TEXT(CFRMainMenuButton, CFRMainMenuButton);

//-----------------------------------------------------------------------------
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRMainMenuButton::CFRMainMenuButton(vgui::Panel *parent, const char *panelName, const char *text) : CExButton(parent, panelName, text)
{
	pImage = new CFRImagePanel(this, "ButtonImage");
	pButton = new CFRButton(this, "ButtonText", text);
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRMainMenuButton::OnThink()
{
	BaseClass::OnThink();
}
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRButton::CFRButton(vgui::Panel *parent, const char *panelName, const char *text) : CExButton(parent, panelName, text)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRButton::ApplySettings(KeyValues *inResourceData)
{
	BaseClass::ApplySettings(inResourceData);
}
...
//-----------------------------------------------------------------------------
void CFRButton::SetArmedBorder(IBorder *border)
{
	_armedBorder = border;
...
//-----------------------------------------------------------------------------
void CFRButton::SetSelectedBorder(IBorder *border)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRButton::ApplySchemeSettings(IScheme *pScheme)
{
	BaseClass::ApplySchemeSettings(pScheme);
...
//-----------------------------------------------------------------------------
IBorder *CFRButton::GetBorder(bool depressed, bool armed, bool selected, bool keyfocus)
{
	if (depressed)
...
// Purpose: 
//-----------------------------------------------------------------------------
vgui::Label::Alignment CFRMainMenuButton::GetAlignment(char* m_szAlignment)
{
	// text alignment
