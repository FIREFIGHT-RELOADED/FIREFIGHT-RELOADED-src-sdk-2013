...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRStoreMenuAmmo::CFRStoreMenuAmmo(IViewPort *pViewPort) : Frame(NULL, PANEL_BUY_AMMO)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/StoreMenu_Ammo.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CFRStoreMenuAmmo::~CFRStoreMenuAmmo()
{
}
...
//-----------------------------------------------------------------------------
void CFRStoreMenuAmmo::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenuAmmo::ShowPanel(bool bShow)
{
...
void CFRStoreMenuAmmo::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
/*
void CFRStoreMenuAmmo::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenuAmmo::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRStoreMenuAmmo::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CFRStoreMenuAmmo::SetLabelText(const char *textEntryName, const char *text)
{
...
void CFRStoreMenuAmmo::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRStoreMenuAmmo::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
