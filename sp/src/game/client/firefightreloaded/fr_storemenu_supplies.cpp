...
#include "fr_storemenu_supplies.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRStoreMenuSupplies::CFRStoreMenuSupplies(IViewPort *pViewPort) : Frame(NULL, PANEL_BUY_SUPPLIES)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/StoreMenu_Supplies.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CFRStoreMenuSupplies::~CFRStoreMenuSupplies()
{
}
...
//-----------------------------------------------------------------------------
void CFRStoreMenuSupplies::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenuSupplies::ShowPanel(bool bShow)
{
...
void CFRStoreMenuSupplies::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenuSupplies::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CFRStoreMenuSupplies::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenuSupplies::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRStoreMenuSupplies::OnTeamButton( int team )
{
	char cmd[64];
...
void CFRStoreMenuSupplies::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRStoreMenuSupplies::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
