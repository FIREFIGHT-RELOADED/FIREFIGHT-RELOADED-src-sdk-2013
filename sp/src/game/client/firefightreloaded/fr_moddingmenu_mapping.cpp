...
#include "fr_moddingmenu_mapping.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRModdingMenu_Mapping::CFRModdingMenu_Mapping(IViewPort *pViewPort) : Frame(NULL, PANEL_MODDING_MAPPING)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/ModdingMenu_Mapping.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CFRModdingMenu_Mapping::~CFRModdingMenu_Mapping()
{
}
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping::ShowPanel(bool bShow)
{
...
void CFRModdingMenu_Mapping::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CFRModdingMenu_Mapping::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping::SetLabelText(const char *textEntryName, const char *text)
{
...
void CFRModdingMenu_Mapping::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRModdingMenu_Mapping::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
