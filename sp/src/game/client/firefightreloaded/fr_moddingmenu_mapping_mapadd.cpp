...
#include "fr_moddingmenu_mapping_mapadd.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRModdingMenu_Mapping_Mapadd::CFRModdingMenu_Mapping_Mapadd(IViewPort *pViewPort) : Frame(NULL, PANEL_MODDING_MAPADD)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/ModdingMenu_Mapping_Mapadd.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CFRModdingMenu_Mapping_Mapadd::~CFRModdingMenu_Mapping_Mapadd()
{
}
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Mapadd::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Mapadd::ShowPanel(bool bShow)
{
...
void CFRModdingMenu_Mapping_Mapadd::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Mapadd::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CFRModdingMenu_Mapping_Mapadd::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Mapadd::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Mapadd::OnTeamButton( int team )
{
	char cmd[64];
...
void CFRModdingMenu_Mapping_Mapadd::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRModdingMenu_Mapping_Mapadd::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
