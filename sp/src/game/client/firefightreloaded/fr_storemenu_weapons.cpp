...
#include "fr_storemenu_weapons.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRStoreMenuWeapons::CFRStoreMenuWeapons(IViewPort *pViewPort) : Frame(NULL, PANEL_BUY_WEAPONS)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/StoreMenu_Weapons.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CFRStoreMenuWeapons::~CFRStoreMenuWeapons()
{
}
...
//-----------------------------------------------------------------------------
void CFRStoreMenuWeapons::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenuWeapons::ShowPanel(bool bShow)
{
...
void CFRStoreMenuWeapons::OnCommand(const char *command)
{
	...
	else if (Q_stricmp(command, "buymenuback"))
	{
		engine->ClientCmd(const_cast<char *>(command));
		Close();
	}
...
//-----------------------------------------------------------------------------
void CFRStoreMenuWeapons::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CFRStoreMenuWeapons::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenuWeapons::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRStoreMenuWeapons::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CFRStoreMenuWeapons::SetLabelText(const char *textEntryName, const char *text)
{
...
void CFRStoreMenuWeapons::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRStoreMenuWeapons::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
