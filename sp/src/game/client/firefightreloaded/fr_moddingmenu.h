...
#ifndef FR_MODDINGMENU_H
#define FR_MODDINGMENU_H
#ifdef _WIN32
#pragma once
#endif
...
//-----------------------------------------------------------------------------
class CFRModdingMenu : public vgui::Frame, public IViewPortPanel
{
private:
	DECLARE_CLASS_SIMPLE( CFRModdingMenu, vgui::Frame );

public:
	CFRModdingMenu(IViewPort *pViewPort);
	virtual ~CFRModdingMenu();

	virtual const char *GetName( void ) { return PANEL_MODDING_MAIN; }
