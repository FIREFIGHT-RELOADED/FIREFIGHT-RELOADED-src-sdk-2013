...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRStoreMenu::CFRStoreMenu(IViewPort *pViewPort) : Frame(NULL, PANEL_BUY)
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenu::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenu::ShowPanel(bool bShow)
{
...
//-----------------------------------------------------------------------------
/*
void CFRStoreMenu::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRStoreMenu::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRStoreMenu::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CFRStoreMenu::SetLabelText(const char *textEntryName, const char *text)
{
...
void CFRStoreMenu::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRStoreMenu::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
