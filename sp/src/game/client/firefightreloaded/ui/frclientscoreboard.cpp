...
// Purpose: Konstructor
//-----------------------------------------------------------------------------
CFRClientScoreBoardDialog::CFRClientScoreBoardDialog(IViewPort *pViewPort):CClientScoreBoardDialog(pViewPort)
{
}
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CFRClientScoreBoardDialog::~CFRClientScoreBoardDialog()
{
}
...
//-----------------------------------------------------------------------------
void CFRClientScoreBoardDialog::PaintBackground()
{
...
//-----------------------------------------------------------------------------
void CFRClientScoreBoardDialog::PaintBorder()
{
	int x1, x2, y1, y2;
...
//-----------------------------------------------------------------------------
void CFRClientScoreBoardDialog::ApplySchemeSettings( vgui::IScheme *pScheme )
{
...
//-----------------------------------------------------------------------------
void CFRClientScoreBoardDialog::InitScoreboardSections()
{
	m_pPlayerList->SetBgColor( Color(0, 0, 0, 0) );
	m_pPlayerList->SetBorder(NULL);
...
//-----------------------------------------------------------------------------
void CFRClientScoreBoardDialog::UpdateTeamInfo()
{
	if ( g_PR == NULL )
		return;
...
//-----------------------------------------------------------------------------
void CFRClientScoreBoardDialog::AddHeader()
{
	// add the top header
...
//-----------------------------------------------------------------------------
void CFRClientScoreBoardDialog::AddSection(int teamType, int teamNumber)
{
	HFont hFallbackFont = scheme()->GetIScheme( GetScheme() )->GetFont( "DefaultVerySmallFallBack", false );
...
int CFRClientScoreBoardDialog::GetSectionFromTeamNumber( int teamNumber )
{
	//always return ffa
	return 3;
}
...
//-----------------------------------------------------------------------------
bool CFRClientScoreBoardDialog::GetPlayerScoreInfo(int playerIndex, KeyValues *kv)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CFRClientScoreBoardDialog::UpdatePlayerInfo()
{
