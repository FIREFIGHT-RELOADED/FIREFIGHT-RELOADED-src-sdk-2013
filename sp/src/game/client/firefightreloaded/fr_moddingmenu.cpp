...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRModdingMenu::CFRModdingMenu(IViewPort *pViewPort) : Frame(NULL, PANEL_MODDING_MAIN)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/ModdingMenu.res");
	InvalidateLayout();
...
//-----------------------------------------------------------------------------
void CFRModdingMenu::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu::ShowPanel(bool bShow)
{
...
void CFRModdingMenu::OnCommand(const char *command)
{
...
//-----------------------------------------------------------------------------
/*
void CFRModdingMenu::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRModdingMenu::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CFRModdingMenu::SetLabelText(const char *textEntryName, const char *text)
{
...
void CFRModdingMenu::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRModdingMenu::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
