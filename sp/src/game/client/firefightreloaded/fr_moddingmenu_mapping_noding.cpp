...
#include "fr_moddingmenu_mapping_noding.h"
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CFRModdingMenu_Mapping_Noding::CFRModdingMenu_Mapping_Noding(IViewPort *pViewPort) : Frame(NULL, PANEL_MODDING_NODING)
{
...
//#endif
	...
	LoadControlSettings("Resource/UI/ModdingMenu_Mapping_Noding.res");
	InvalidateLayout();
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CFRModdingMenu_Mapping_Noding::~CFRModdingMenu_Mapping_Noding()
{
}
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Noding::ApplySchemeSettings(IScheme *pScheme)
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Noding::ShowPanel(bool bShow)
{
...
void CFRModdingMenu_Mapping_Noding::OnCommand(const char *command)
{
	if (Q_stricmp(command, "moddingcancel"))
	{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Noding::Update()
{
	/*
...
//-----------------------------------------------------------------------------
/*
void CFRModdingMenu_Mapping_Noding::LoadMapPage( const char *mapName )
{
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Noding::MakeTeamButtons(void)
{
	int i = 0;
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Noding::OnTeamButton( int team )
{
	char cmd[64];
...
//-----------------------------------------------------------------------------
void CFRModdingMenu_Mapping_Noding::SetLabelText(const char *textEntryName, const char *text)
{
...
void CFRModdingMenu_Mapping_Noding::OnKeyCodePressed(KeyCode code)
{
	int nDir = 0;
...
void CFRModdingMenu_Mapping_Noding::MoveToCenterOfScreen()
{
	int wx, wy, ww, wt;
