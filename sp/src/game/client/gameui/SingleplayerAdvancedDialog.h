...
//-----------------------------------------------------------------------------
class CSingleplayerAdvancedDialog : public vgui::Frame
{
	DECLARE_CLASS_SIMPLE(CSingleplayerAdvancedDialog, vgui::Frame);

public:
	CSingleplayerAdvancedDialog(vgui::Panel *parent);
	~CSingleplayerAdvancedDialog();
