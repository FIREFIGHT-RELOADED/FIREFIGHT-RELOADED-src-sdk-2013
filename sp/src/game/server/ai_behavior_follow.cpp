...
#ifdef HL2_DLL
					bIsEpisodicVitalAlly = (hl2_episodic.GetBool() && (GetOuter()->Classify() == CLASS_PLAYER_ALLY_VITAL || GetOuter()->Classify() == CLASS_PLAYER_NPC || GetOuter()->Classify() == CLASS_VORTIGAUNT));
#else
