...
#include "cbase.h"
#include "weapon_frbasehlmpcombatweapon.h"
...
LINK_ENTITY_TO_CLASS( basefrcombatweapon, CBaseFRCombatWeapon );

IMPLEMENT_NETWORKCLASS_ALIASED( BaseFRCombatWeapon , DT_BaseFRCombatWeapon )

BEGIN_NETWORK_TABLE( CBaseFRCombatWeapon , DT_BaseFRCombatWeapon )
...
// Save/Restore
//---------------------------------------------------------
BEGIN_DATADESC( CBaseFRCombatWeapon )
...
BEGIN_PREDICTION_DATA( CBaseFRCombatWeapon )
END_PREDICTION_DATA()

extern ConVar sk_auto_reload_time;

CBaseFRCombatWeapon::CBaseFRCombatWeapon( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CBaseFRCombatWeapon::ItemHolsterFrame( void )
{
...
//-----------------------------------------------------------------------------
bool CBaseFRCombatWeapon::Lower( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseFRCombatWeapon::Ready( void )
{
	//Don't bother if we don't have the animation
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseFRCombatWeapon::Deploy( void )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseFRCombatWeapon::Holster( CBaseCombatWeapon *pSwitchingTo )
{
...
// Output : Returns true on success, false on failure.
//-----------------------------------------------------------------------------
bool CBaseFRCombatWeapon::WeaponShouldBeLowered( void )
{
...
//-----------------------------------------------------------------------------
void CBaseFRCombatWeapon::WeaponIdle( void )
{
...
// Output : float
//-----------------------------------------------------------------------------
float CBaseFRCombatWeapon::CalcViewmodelBob( void )
{
...
//			viewmodelindex - 
//-----------------------------------------------------------------------------
void CBaseFRCombatWeapon::AddViewmodelBob( CBaseViewModel *viewmodel, Vector &origin, QAngle &angles )
{
...
//-----------------------------------------------------------------------------
Vector CBaseFRCombatWeapon::GetBulletSpread( WeaponProficiency_t proficiency )
{
	return BaseClass::GetBulletSpread( proficiency );
}

//-----------------------------------------------------------------------------
float CBaseFRCombatWeapon::GetSpreadBias( WeaponProficiency_t proficiency )
{
	return BaseClass::GetSpreadBias( proficiency );
}
//-----------------------------------------------------------------------------

const WeaponProficiencyInfo_t *CBaseFRCombatWeapon::GetProficiencyValues()
{
	return NULL;
}
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CBaseFRCombatWeapon::GetDefaultProficiencyValues()
{
